...
const HeaderPath = [{
    name: 'rabbit',
    path: '/static/images/CommentHeader/rabbit.jpg'
  },
  {
    name: 'bear',
    path: '/static/images/CommentHeader/bear.jpg'
  },
  {
    name: 'smile',
    path: '/static/images/CommentHeader/smile.jpg'
  },
  {
    name: 'girl',
    path: '/static/images/CommentHeader/girl.jpg'
  },
  {
    name: 'rhizomys',
    path: '/static/images/CommentHeader/rhizomys.jpg'
  },
  {
    name: 'duck',
    path: '/static/images/CommentHeader/duck.jpg'
  },
  {
    name: 'xiaohuangren',
    path: '/static/images/CommentHeader/xiaohuangren.jpg'
  }
];
...
function changeImagePath(image) {
  ...
  // if (image[0] !== "h")
  //   image = "http://722first.club" + image;
  return image;
}
